...
// EcsClient is an autogenerated mock type for the EcsClient type
type EcsClient struct {
	mock.Mock
}

// StopTask provides a mock function with given fields: ctx, params, optFns
func (_m *EcsClient) StopTask(ctx context.Context, params *ecs.StopTaskInput, optFns ...func(*ecs.Options)) (*ecs.StopTaskOutput, error) {
...
// NewEcsClient creates a new instance of EcsClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewEcsClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *EcsClient {
	mock := &EcsClient{}
